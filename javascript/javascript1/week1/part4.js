...
if (addPlasticBag){
    ...
    console.log ("Added plastic bag: 5 DKK");
} else {
    let plasticBagPrice = 0;
    console.log ("No plastic bag added");
}

let finalPrice1 = totalPrice2 + addPlasticBag - pizzaDiscount;
const addVat = 0.25;
console.log("VAT (25%): ", addVat*finalPrice1, "DKK");
let finalPrice2 = finalPrice1 + addVat*finalPrice1 + plasticBagPrice;
